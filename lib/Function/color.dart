...
class Palette {
  static const Color main = Color(0xffff4d00);
  ...
  static const Color textl = Color(0xff9d9d9d);
  static const Color border = Color(0xff252525);
  static const Color bgd2 = Color(0xff0b183f);
  static const Color bgd = Color(0xff263d73);
  static const Color bgl = Color(0xff1e305d);
  ...
  static const Color blue = Color(0xff26a6ff);
