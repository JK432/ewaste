...
class CmpnyDeviceScreen extends StatefulWidget {
  final Device device;
  const CmpnyDeviceScreen({Key? key, required this.device}) : super(key: key);

  @override
  State<CmpnyDeviceScreen> createState() => _CmpnyDeviceScreenState();
}

class _CmpnyDeviceScreenState extends State<CmpnyDeviceScreen> {
  @override
